...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoosendApi.Context110();
  });
  ...
  describe('Context110', function() {
    it('should create an instance of Context110', function() {
      // uncomment below and update the code to test Context110
      //var instane = new MoosendApi.Context110();
      //expect(instance).to.be.a(MoosendApi.Context110);
    });
