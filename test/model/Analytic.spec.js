...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoosendApi.Analytic();
  });
  ...
  describe('Analytic', function() {
    it('should create an instance of Analytic', function() {
      ...
      //var instane = new MoosendApi.Analytic();
      //expect(instance).to.be.a(MoosendApi.Analytic);
    });
    ...
    it('should have the property contextDescription (base name: "ContextDescription")', function() {
      // uncomment below and update the code to test the property contextDescription
      //var instane = new MoosendApi.Analytic();
      //expect(instance).to.be();
    });
    ...
    it('should have the property uniqueCount (base name: "UniqueCount")', function() {
