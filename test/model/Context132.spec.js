...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoosendApi.Context132();
  });
  ...
  describe('Context132', function() {
    it('should create an instance of Context132', function() {
      // uncomment below and update the code to test Context132
      //var instane = new MoosendApi.Context132();
      //expect(instance).to.be.a(MoosendApi.Context132);
    });
