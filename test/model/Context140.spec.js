...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoosendApi.Context140();
  });
  ...
  describe('Context140', function() {
    it('should create an instance of Context140', function() {
      // uncomment below and update the code to test Context140
      //var instane = new MoosendApi.Context140();
      //expect(instance).to.be.a(MoosendApi.Context140);
    });
