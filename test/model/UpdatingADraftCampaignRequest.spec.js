...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoosendApi.UpdatingADraftCampaignRequest();
  });
  ...
  describe('UpdatingADraftCampaignRequest', function() {
    it('should create an instance of UpdatingADraftCampaignRequest', function() {
      // uncomment below and update the code to test UpdatingADraftCampaignRequest
      //var instane = new MoosendApi.UpdatingADraftCampaignRequest();
      //expect(instance).to.be.a(MoosendApi.UpdatingADraftCampaignRequest);
    });
