...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoosendApi.Context32();
  });
  ...
  describe('Context32', function() {
    it('should create an instance of Context32', function() {
      // uncomment below and update the code to test Context32
      //var instane = new MoosendApi.Context32();
      //expect(instance).to.be.a(MoosendApi.Context32);
    });
