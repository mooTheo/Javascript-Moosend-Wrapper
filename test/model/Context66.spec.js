...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoosendApi.Context66();
  });
  ...
  describe('Context66', function() {
    it('should create an instance of Context66', function() {
      // uncomment below and update the code to test Context66
      //var instane = new MoosendApi.Context66();
      //expect(instance).to.be.a(MoosendApi.Context66);
    });
