...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoosendApi.Context93();
  });
  ...
  describe('Context93', function() {
    it('should create an instance of Context93', function() {
      // uncomment below and update the code to test Context93
      //var instane = new MoosendApi.Context93();
      //expect(instance).to.be.a(MoosendApi.Context93);
    });
