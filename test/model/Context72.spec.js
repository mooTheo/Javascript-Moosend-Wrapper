...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoosendApi.Context72();
  });
  ...
  describe('Context72', function() {
    it('should create an instance of Context72', function() {
      // uncomment below and update the code to test Context72
      //var instane = new MoosendApi.Context72();
      //expect(instance).to.be.a(MoosendApi.Context72);
    });
