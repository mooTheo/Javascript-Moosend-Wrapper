...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoosendApi.Context52();
  });
  ...
  describe('Context52', function() {
    it('should create an instance of Context52', function() {
      // uncomment below and update the code to test Context52
      //var instane = new MoosendApi.Context52();
      //expect(instance).to.be.a(MoosendApi.Context52);
    });
